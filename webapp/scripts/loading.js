var loading = {
    init: function() {
        //根据windows.path获取加载的JS，开发版本使用 ?debug
...
var _resource = {
    page: {
        ...
        '/pages/lots/preview.html': [
            ...
            '/scripts/plugin/plugin.lot.js',
            '/scripts/plugin/plugin.page.js',
            '/scripts/plugin/calendar.js',
            '/scripts/pages/preview.js',
            '/scripts/plugin/plugin.footer.js'
        ],
        '/pages/meeting/conference.html': [
            ...
            '/scripts/global/connection.js',
            '/scripts/plugin/auctionnumber.js',
            '/scripts/pages/auction_refer.js',
    ...
    buildTime: '|now|',
    testurl: 'http://ys.caa123.org.cn/shop', //测试网址
    officialurl: 'http://paimai.caa123.org.cn/shop', //正式网址
