...
myauction.proxyhtml = '<li><a href="javascript:void(0)"><div class="img-wrap"><img src="/themes/images/meeting.jpg" alt=""><div class="other-wrap">' +
    '<p class="meeting-type">专业拍+顺序排</p><p class="meetingtitle">拍卖title</p></div>' +
    ...
    '</p><p class="text14-999">开拍时间：<span class="text16-333">4月15日 13：30</span></p><p class="text14-999">拍品数量：<span class="text16-333">5个</span>' +
