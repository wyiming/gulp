...
$.fn.appendFooter = function() {
    var footerHTML = '<div class="judicial-school ">' +
        ...
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_index.html#a3" target="_blank ">竞拍流程</a></li>' +
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_rule.html#b4" target="_blank ">出价竞拍规则</a></li>' +
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_explain.html#c12" target="_blank ">延时规则</a></li>' +
        '</ul>' +
        '<ul class="judicial-school-ul">' +
        '<h2 class="judicial-school-h2">支付帮助</h2>' +
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_buy.html#d4" target="_blank ">如何报名交保证金</a></li>' +
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_problem.html#e1" target="_blank ">交保遇到限额</a></li>' +
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_buy.html#d6" target="_blank ">尾款如何支付</a></li>' +
        '</ul>' +
        '<ul class="judicial-school-ul">' +
        ...
        '<li class="judicial-school-li"><a href="/pages/help/helpcenter_problem.html#e8 " target="_blank ">如何办理过户</a></li>' +
        '</ul>' +
        '<ul class="judicial-school-ul about-us">' +
        '<h2 class="judicial-school-h2">关于我们</h2>' +
        '<li class="judicial-school-li">邮编: 101100</li>' +
        ...
        '</div>' +
        '<div class="container ">' +
        '<p class="sifa-foot-p"><span  class="sifa-foot-s">京公网安备：1101051611</span>|<span class="sifa-foot-s">备案号：京ICP备13044676号</span>|<span class="sifa-foot-s">中国拍卖行业协会版权所有</span></p>' +
        '</div>';
    if (this.length < 0) {
