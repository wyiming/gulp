                 ...
                 if (i == 0) {
                     ...
                     for (var e = 1; e <= 7; e++) {
                         ...
                         if ((7 * (i - 1) + kui_i2) > this_max_date) {
                             ...
                             arr_tr.push('<dt class="' + cla2 + '" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,' + now_date + ',' + kui_y + ',' + kui_m + ',' + kui_d + ');">' + (7 * (i - 1) + kui_i) + '</dt>');
                         }
                         kui_i2++;
                     }
                 } else {
                     ...
                     for (var f = 1; f <= 7; f++) {
                         ...
                         arr_tr.push('<dt class="' + cla3 + '" onmouseover="kui_mouseover_(this)" onmouseout="kui_mouseout_(this)" onclick="kui_click_(this,' + now_date + ',' + kui_y + ',' + kui_m + ',' + kui_d + ',1);">' + (7 * (i - 1) + kui_i) + '</dt>');
                         kui_i3++;
                     }
                 }
             }
