$(function() {
    ...
    $.ajax({
        url: "/caa-search-ws/ws/0.1/lots?start=" + num + "&count=12&sortname=" + sortname + "&sortorder=" + sortorder + "&name=" + namevalue + "&status=" + status +
            ...
            '&term=' + term + '&startTimeStamp=' + startTimeStamp + '&endTimeStamp=' + endTimeStamp,
        type: 'get',
        dataType: 'json',
    ...
    $('.time-btn').click(function() {
        var starttime = $('.starttime').val() ? new Date($('.starttime').val()).getTime() : '',
            endtime = $('.endtime').val() ? new Date($('.endtime').val()).getTime() : '';
    ...
    function setdata() {
        //拍品类型
        $.ajax({
            url: '/personal-ws/ws/0.1/auction/lots/type',
            type: 'get',
            dataType: 'json',
            cache: false,
            async: true,
        ...
        $.ajax({
            url: '/caa-web-ws/ws/0.1/auction/lots/loction',
            type: 'get',
            dataType: 'json',
            cache: false,
            async: true,
