...
var PAGE_LOT_CONTROLLER = {
    ...
    detailinit: function() {
        ...
        util.getdata('/caa-search-ws/ws/0.1/lot/' + PAGE_LOT_DATA.lotId + '/introduction/', 'get', 'json', false, true, function(data) {
            ...
            $('#J_desc').html(data.describe); //拍品介绍
...
(function($) {
    ...
    $.fn.finishBidCommon = function(data) {
        ...
        if (PAGE_LOT_DATA.lotMode == 1) {
            endprice = PAGE_LOT_DATA.amount * PAGE_LOT_DATA.nowPrice;
        }
        var display = '<ul class="pm-bid-eyebrow end_time">' +
            ...
            '<p class="pp_endstate" style="padding-top: 30px">本拍品拍卖已结束</p>' +
    ...
    $.fn.finishBidOutter = function(data) {
        this.find(".pm-bid").append('<p class="result">很遗憾，您未获得获得本拍品。<a href="/pages/personal/home.html?showuse=3&lotId=' + PAGE_LOT_DATA.lotId + '" class="colorred">查看保证金</a></p>');
    ...
    $.fn.timefinish = function() {
        ...
        var display =
            '<div class="pm-bid tex-center" id="J_finish_result">' +
            '<p class="pp_endstate" style="padding-top: 24px;">本拍品倒计时已结束</p>' +
