...
$(function() {
    ...
    $(".next-step").click(function() {
            ...
            if ($(".username").val() == "" && ind == 2) {
                showMsg($(".user-error"))
                $(".user-error em").html("由字母、数字或“_”组成，长度不少于6位,不多于30位")
                return
            }
            if ($(".pass-num").val() == "" && ind == 2 || $(".pass-num").length > 20) {
                showMsg($(".pass-error"))
                $(".pass-error span").html("6-20字符，支持大小写字母，数字，“_”格式")
                return
            }
            ...
            if (!(/\w+/g).test($('.username').val()) && ind == 2) {
                $(".user-error").show();
            ...
            if ($("input").val() != "" && ind == 2) {
                ...
                if (ifBol) {
                    ...
                    if (type == 1) {
                        ...
                        if (str1.length <= 5 && ind == 2) {
                            showMsg($(".user-error"))
                            $(".user-error em").html("用户名过短")
                            return
                        }
                        if (txt.length <= 6 && ind == 2) {
                            showMsg($(".pass-error"))
